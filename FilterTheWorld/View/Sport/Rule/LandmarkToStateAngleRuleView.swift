...
struct LandmarkToStateAngleRuleView: View {
    ...
    func updateLocalData() {
        let length = sportManager.getRuleLandmarkToStateAngle(id: landmarkToStateAngle.id)
    ...
    func updateRemoteData() {
        sportManager.updateRuleLandmarkToStateAngle(
                                               toStateId: toStateId,
    ...
    var body: some View {
        VStack {
            ...
            HStack {
                ...
                Button(action: {
                    sportManager.removeRuleLandmarkToStateAngle(id: landmarkToStateAngle.id)
