...
struct LandmarkSegmentToStateAngleRuleView: View {
    ...
    func updateRemoteData() {
        sportManager.updateRuleLandmarkSegmentToStateAngle(
                                               ...
                                               warningContent: warningContent, triggeredWhenRuleMet: triggeredWhenRuleMet, delayTime: delayTime, changeStateClear: changeStateClear, id: landmarkSegmentToStateAngle.id)
